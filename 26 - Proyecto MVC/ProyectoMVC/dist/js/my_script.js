...
function base_url(texto){
	return "http://localhost/ProyectoMVC/index.php/"+texto;
}
...
function cargarPersonas(){
	...
	.then( data => {
		...
		for (var i = 0; i < data.length; i++) {
			html_tr = `
						<tr>
				            <td class="py-2 px-1 text-center" >${ data[i].cedula }</td>
				            <td class="py-2 px-1 text-center" >${ data[i].nombres }</td>
				            <td class="py-2 px-1 text-center" >${ data[i].apellidos }</td>
				            <td class="py-2 px-1 text-center" >${ data[i].telefono }</td>
				            <td class="py-2 px-1 text-center" >${ data[i].direccion }</td>
				            <td class="py-2 px-1 text-center" >${ data[i].email }</td>
				        </tr>
					  `;
